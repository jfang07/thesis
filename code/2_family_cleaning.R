...
long_fam_merged$race <- ifelse(long_fam_merged$race %in% c(0,8,9), NA, long_fam_merged$race)
...
long_fam_merged$wages <- ifelse(long_fam_merged$wages >= 9999999 | (long_fam_merged$wages == 9 & long_fam_merged$year <= 1969), NA, long_fam_merged$wages)
...
long_fam_merged$wages <- case_when(
  long_fam_merged$year <= 1969 & long_fam_merged$wages == 1 ~ 250,
  long_fam_merged$year <= 1969 & long_fam_merged$wages == 2 ~ 750,
  long_fam_merged$year <= 1969 & long_fam_merged$wages == 3 ~ 1500,
  long_fam_merged$year <= 1969 & long_fam_merged$wages == 4 ~ 2500,
  long_fam_merged$year <= 1969 & long_fam_merged$wages == 5 ~ 4000,
  long_fam_merged$year <= 1969 & long_fam_merged$wages == 6 ~ 6250,
  long_fam_merged$year <= 1969 & long_fam_merged$wages == 7 ~ 8750,
  long_fam_merged$year <= 1969 & long_fam_merged$wages == 8 ~ 10000, # exception bc this is the lower bound
